 ...
 *
 * A Bean running this sketch advertises custom data. Bean continues to
 * advertise as itself by switching back and forth between Bean advertising
 * data and custom data.
 *
 * Upload this sketch to Bean, then toggle pin 0 to send custom BLE advertising
 * packets.
 *
 * Use this in conjunction with another Bean running observer.ino to share data
 * between Beans.
 */
