 ...
 *
 * When you disconnect from an ANCS Bean you'll need to manually forget it from the settings menu
 */
...
void loop() {
    ...
    if (msgAvail) {
        ...
        for (int i = 0; i < msgAvail; i ++) {
            ...
            int len = BeanAncs.getNotificationAttributes(NOTI_ATTR_ID_MESSAGE,
