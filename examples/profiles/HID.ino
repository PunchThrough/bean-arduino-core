...
// Important, when disconnecting from a device, you must manually forget the Bean in the system bluetooth menu as well as the loader
...
void loop() {
  ...
  //we want to map the movements to reasonable values.  This constrains the accelerometer to -20 to 20.
