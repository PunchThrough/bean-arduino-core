 ...
 * In this mode, Bean can connect to a Mac or iOS device and use an app that
 * has Core MIDI enabled, e.g. GarageBand.
 * Bean will play a scale, play a chord, and bend a note.
 */
