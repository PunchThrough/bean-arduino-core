...
const HIDDescriptor _hidInterface = {
    ...
    D_ENDPOINT(USB_ENDPOINT_IN(HID_ENDPOINT_INT), USB_ENDPOINT_TYPE_INTERRUPT,
               0x40, 0x01)};
...
void Mouse_::press(uint8_t b) { buttons(_buttons | b); }

void Mouse_::release(uint8_t b) { buttons(_buttons & ~b); }
