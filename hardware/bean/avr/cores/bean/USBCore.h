...
#define D_DEVICE(_class, _subClass, _proto, _packetSize0, _vid, _pid,  \
                 _version, _im, _ip, _is, _configs)                    \
  {                                                                    \
    18, 1, 0x200, _class, _subClass, _proto, _packetSize0, _vid, _pid, \
        _version, _im, _ip, _is, _configs                              \
  }

#define D_CONFIG(_totalLength, _interfaces)                        \
  {                                                                \
    9, 2, _totalLength, _interfaces, 1, 0, USB_CONFIG_BUS_POWERED, \
