...
\hline
{\em I\+D} & is the U\+U\+I\+D of the notification as contained in A\+N\+C\+S\+\_\+\+S\+O\+U\+R\+C\+E\+\_\+\+M\+S\+G\+\_\+\+T. \\
\hline
...
\subsubsection[{get\+Notification\+Header()}]{\setlength{\rightskip}{0pt plus 5cm}A\+N\+C\+S\+\_\+\+S\+O\+U\+R\+C\+E\+\_\+\+M\+S\+G\+\_\+\+T Bean\+Ancs\+Class\+::get\+Notification\+Header (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\begin{DoxyParamCaption}
\item[{A\+N\+C\+S\+\_\+\+S\+O\+U\+R\+C\+E\+\_\+\+M\+S\+G\+\_\+\+T $\ast$}]{buffer, }
...
\begin{DoxyParams}{Parameters}
{\em buffer} & takes a user defined buffer of type A\+N\+C\+S\+\_\+\+S\+O\+U\+R\+C\+E\+\_\+\+M\+S\+G\+\_\+\+T. When this function returns the buffer will be populated with messages \\
\hline
